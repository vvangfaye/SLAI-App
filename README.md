...
考勤时长与达标状态以学校数据为准；年假账本为个人记录，不同步学校余额。核心登录链路已通过真机验证，主页面完整同步仍待真机验收，尚未发布正式版。

更多细节：[接入设计](docs/integration.md) · [验证记录](docs/login-verification.md) · [日历与年假](docs/calendar-and-leave.md)
